    ...
    return (
        <div ref={ref} className="invoice-preview-container bg-white text-black p-8">
            <Card className="w-full shadow-none border-0" style={{ width: '800px', borderRadius: '0' }}>
                                ...
                                <TableBody>
                                    {quotation.lineItems.map((item, index) => (
                                        <TableRow key={index} className="border-b-0">
                                            ...
                                            {previewColumns.map(col => {
                                                const isDefault = ['name', 'unit', 'hsnCode', 'quantity', 'unitPrice', 'discount'].includes(col.id);
                ...
                <div data-pdf-footer>
                    <CardFooter className="p-2 text-center text-[10px] text-gray-500 border-t border-gray-200">
                        <div className='w-full'>
                            <p>For questions concerning this quotation, please contact: </p>
                            <p>
